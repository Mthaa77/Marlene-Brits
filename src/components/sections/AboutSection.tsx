    ...
    <section id="about" className="scroll-mt-24 bg-white py-20 sm:py-24 lg:py-28">
      <div className="mx-auto grid max-w-[88rem] gap-10 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16 lg:px-8">
        ...
        <motion.div initial={reduceMotion ? false : { opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="pt-5 lg:pt-0">
          ...
          <h2 className="premium-heading mt-4 max-w-xl font-serif text-[clamp(2.9rem,6vw,5.3rem)] font-medium leading-[0.93] tracking-[-0.05em] text-[#07111f]">Built on trust. Measured by the clarity clients <span className="italic text-[#a87535]">receive.</span></h2>
          <p className="premium-lede mt-6 text-[#526071] sm:text-lg">Based at Pegasus Building 1 in Menlyn Maine, Marlene Brits Attorneys combines legal precision with genuinely personal service across conveyancing, deceased estates, estate planning, family matters, notarial work and civil disputes.</p>
