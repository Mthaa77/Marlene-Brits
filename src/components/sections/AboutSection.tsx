    ...
    <section id="about" className="scroll-mt-24 bg-white py-20 sm:py-24 lg:py-28">
      <div className="mx-auto grid max-w-[88rem] gap-10 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16 lg:px-8">
        ...
        <motion.div initial={reduceMotion ? false : { opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="pt-5 lg:pt-0">
          ...
          <p className="mt-6 text-base leading-8 text-[#526071] sm:text-lg">Marlene Brits Attorneys is a Pretoria East practice providing focused legal support across conveyancing, deceased estate administration, notarial services, estate planning and related matters.</p>
          <p className="mt-4 text-base leading-8 text-[#526071]">The standard is simple: clients should understand the process, know what comes next, and feel supported throughout.</p>
