  ...
  return (
    <section id="why-choose-us" className="relative overflow-hidden bg-[#07111f] py-20 text-white sm:py-24 lg:py-28">
      ...
      <div className="relative mx-auto max-w-[88rem] px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center"><span className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#d9af6b]">The Marlene Brits standard</span><h2 className="mt-4 font-serif text-[clamp(2.8rem,6vw,5.2rem)] font-medium leading-[0.94] tracking-[-0.05em] text-[#fffaf1]">Serious legal work. A distinctly human experience.</h2><p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-white/52 sm:text-base">Professional rigour should never make you feel removed from your own matter. The firm combines careful legal execution with communication that keeps you informed, involved and able to make the next decision with confidence.</p></div>
