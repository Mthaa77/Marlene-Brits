      ...
      <div className="relative mx-auto max-w-[88rem]">
        <div className="relative overflow-hidden rounded-[2rem_5rem_2rem_2rem] border border-[#d9af6b]/24 bg-[linear-gradient(120deg,rgba(217,175,107,0.16),rgba(255,255,255,0.035)_52%,rgba(217,175,107,0.08))] px-6 py-9 shadow-[0_34px_110px_rgba(0,0,0,0.3)] sm:px-10 sm:py-11 lg:px-12">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div><span className="text-[9px] font-semibold uppercase tracking-[0.24em] text-[#d9af6b]">A clearer first step</span><h2 className="mt-4 max-w-4xl font-serif text-[clamp(2.5rem,5vw,5rem)] font-medium leading-[0.92] tracking-[-0.05em] text-[#fffaf1]">Your legal matter deserves a thoughtful conversation.</h2><p className="mt-5 max-w-2xl text-sm leading-7 text-white/54 sm:text-base">Speak directly with a Pretoria East legal team that values clear guidance, careful execution and personal attention.</p></div>
