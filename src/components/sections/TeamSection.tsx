  ...
  return (
    <section id="team" className="scroll-mt-24 bg-white py-20 sm:py-24 lg:py-28">
      <div className="mx-auto grid max-w-[88rem] gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-16 lg:px-8">
        ...
        <div className="pt-5 lg:pt-0"><span className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#9b6d30]">The legal team</span><h2 className="mt-4 max-w-2xl font-serif text-[clamp(2.8rem,6vw,5.2rem)] font-medium leading-[0.94] tracking-[-0.05em] text-[#07111f]">Experience you can reach. Counsel you can understand.</h2><p className="mt-6 max-w-2xl text-base leading-8 text-[#526071] sm:text-lg">Led by founder Marlene Brits, the practice combines technical legal capability with a personal, approachable service experience.</p>
