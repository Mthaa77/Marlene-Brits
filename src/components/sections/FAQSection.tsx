  ...
  return (
    <section id="faq" className="scroll-mt-24 bg-[#f7f3eb] py-20 sm:py-24 lg:py-28">
      <div className="mx-auto grid max-w-[88rem] gap-10 px-4 sm:px-6 lg:grid-cols-[0.75fr_1.25fr] lg:gap-16 lg:px-8">
        <div><span className="inline-flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.24em] text-[#9b6d30]"><HelpCircle className="h-3.5 w-3.5" /> Client questions</span><h2 className="mt-4 font-serif text-[clamp(2.8rem,6vw,5rem)] font-medium leading-[0.94] tracking-[-0.05em] text-[#07111f]">Clarity before you begin.</h2><p className="mt-6 max-w-lg text-base leading-8 text-[#526071]">A first conversation can replace uncertainty with a clear understanding of what your matter needs.</p><a href="tel:+27766116965" className="mt-7 inline-flex min-h-12 items-center gap-2 rounded-xl bg-[#07111f] px-5 text-sm font-semibold text-white transition hover:bg-[#0c2136]"><PhoneCall className="h-4 w-4 text-[#edcd94]" /> Call the firm</a></div>
